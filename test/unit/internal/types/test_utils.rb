...
describe Mailhub::Internal::Types::Utils do
  Utils = Mailhub::Internal::Types::Utils

  module TestUtils
    class M < Mailhub::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Mailhub::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Mailhub::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend Mailhub::Internal::Types::Union
    ...
    SymbolStringHash = Mailhub::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Mailhub::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "String" do
      ...
      it "raises an error if value cannot be coerced and strict" do
        assert_raises Mailhub::Internal::Errors::TypeError do
    ...
    describe "Array" do
      StringArray = Mailhub::Internal::Types::Array[String]
      ModelArray = -> { Mailhub::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Mailhub::Internal::Types::Array[TestUtils::U] }
