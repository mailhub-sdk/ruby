...
describe Mailhub::Internal::Types::Union do
  class Rectangle < Mailhub::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Mailhub::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Mailhub::Internal::Types::Model
