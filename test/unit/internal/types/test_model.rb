...
describe Mailhub::Internal::Types::Model do
  ...
  class ExampleModel < Mailhub::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Mailhub::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Mailhub::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Mailhub::Internal::Types::Model
