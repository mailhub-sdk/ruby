...
require_relative "lib/Mailhub/version"
...
Gem::Specification.new do |spec|
  spec.name = "Mailhub"
  spec.authors = ["Mailhub"]
  spec.version = Mailhub::VERSION
  spec.summary = "Ruby client library for the Mailhub API"
  spec.description = "The Mailhub Ruby library provides convenient access to the Mailhub API from Ruby."
